...
describe ParseReportJob, type: :job do
  ...
  # The job now receives the report packed by the consumer (ReportArtifact),
  # not an index — no second download. Parser is stubbed, so the payload
  # contents are irrelevant beyond unpacking cleanly.
